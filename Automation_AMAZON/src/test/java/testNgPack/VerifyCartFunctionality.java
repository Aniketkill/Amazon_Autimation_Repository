...
public class VerifyCartFunctionality extends Base{
	...
	public void verifyAddtoCartFunctionality() {
		...
		System.out.println("verifyAddtoCartFunctionality");

		String exp = "Added to Cart";
		String act = addtoCart_Page.getOrderconfirmation();

		Assert.assertEquals(act, exp);
	}

	@Test(priority = 1)
	public void verifyGoToCartFunctionality() {

		System.out.println("verifyGoToCartFunctionality");
		addtoCart_Page.clickOnGoToCart();

		String exp = "https://www.amazon.in/gp/cart/view.html?ref_=sw_gtc";
		String act = addtoCart_Page.getURL();
